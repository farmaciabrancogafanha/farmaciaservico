...
| https://farmaciaservicoilhavoaveiro.netlify.app/farmacias | Lista de todas as farmácias dos dois concelhos, com destaque das de serviço hoje |
...
- Página de listagem de todas as farmácias dos dois concelhos (`/farmacias`), ordenada pela sequência real do serviço, com destaque da farmácia de serviço do dia
...
HTML5, CSS e JavaScript vanilla. Ficheiro único `index.html`, sem frameworks nem bundler. Hospedado em Netlify com auto-deploy a partir do GitHub. Serviços externos: GoatCounter para estatísticas de visitas (sem cookies nem dados pessoais) e api.qrserver.com para gerar as imagens dos QR codes.
